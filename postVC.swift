...
class postVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let backBtn = UIBarButtonItem(image: UIImage(named: "back.png"), style: UIBarButtonItemStyle.plain
            , target: self, action: #selector(postVC.back(sender:)))
        self.navigationItem.leftBarButtonItem = backBtn
        
        //swip to go back
        let backSwipe = UISwipeGestureRecognizer(target: self, action: #selector(postVC.back(sender:)))
    ...
    func back(sender: UIBarButtonItem){
        ...
        //clean post uuid from last hoder
        if !postuuid.isEmpty{
